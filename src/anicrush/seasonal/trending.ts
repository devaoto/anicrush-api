...
import { seasonalResponseSchema, formattedSeasonalResponseSchema } from "./types";

export const getTrending = async (limit?: number) => {
    const response = await anicrushApi.get('shared/v2/movie/trending');
...
// console.dir(await getTrending(), { depth: null });
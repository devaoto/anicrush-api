...
import type { ExtractedSrc, UnencryptedSrc } from "./types";
import { getRandomUserAgentString } from "../../../utils.js";

const embed_url = "https://megacloud.tv/embed-2/e-1/";
const referrer = "https://megacloud.tv";
const user_agent = getRandomUserAgentString();
...
async function QN(QP: Response, Qn: WebAssembly.Imports) {
  ...
  return "function" == typeof Response && isResponse(QP)
    ...
    : (Qt = await WebAssembly.instantiate(QP as any, Qn)) instanceof
...
export async function getMegacloudSources(xrax: string) {
